...
if form.keys():
	...
	print '<p>Here are the values of you %s form submission:</p>' %verb
	print '<ul>'
	for field in form.keys():
		valueObject = form[field]
		if isinstance(valueObject, list):
			#More than on value was submitted. We therefore have a 
			#while list of ValueObject.getList() would have given us
		...
		#only one values was subitted, we thereform have onluy one valuesObject,getfirst() would bave givensis the string value directly.
